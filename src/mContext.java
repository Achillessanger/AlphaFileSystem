...
public class mContext {
    ...
    static {
        ...
        myBlockManagerMap.put(new StringId("bm-01"),new myBlockManager("./path/to/bm-01/",new StringId("bm-01")));
        myBlockManagerMap.put(new StringId("bm-02"),new myBlockManager("./path/to/bm-02/",new StringId("bm-02")));
        myBlockManagerMap.put(new StringId("bm-03"),new myBlockManager("./path/to/bm-03/",new StringId("bm-03")));
